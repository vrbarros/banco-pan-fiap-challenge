...
function ApiRequests() {
  ...
  return (
    <>
      <Head>
        <title>API Requests - Tokyo NextJS Javascript Admin Dashboard</title>
      </Head>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Throughout Tokyo NextJS Javascript Admin Dashboard you will find a
...
ApiRequests.getLayout = function getLayout(page) {
