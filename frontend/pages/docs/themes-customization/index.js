...
function ThemesCustomization() {
  ...
  return (
    <>
      <Head>
        <title>
          Themes Customization - Tokyo NextJS Javascript Admin Dashboard
        </title>
      </Head>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo NextJS Javascript Admin Dashboard comes with 6 predefined
              color schemes.
            </Typography>
            <Typography paragraph>
...
ThemesCustomization.getLayout = function getLayout(page) {
