...
function HeaderUserbox() {
  ...
  return (
    <>
      <Head>
        <title>Authentication - Tokyo NextJS Javascript Admin Dashboard</title>
      </Head>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo NextJS Javascript Admin Dashboard includes four separate
            ...
            <Typography paragraph>
              ...
              default, Tokyo NextJS Javascript Admin Dashboard comes with JWT
              Web Tokens enabled.
            </Typography>
            <Typography paragraph>
            ...
            <Typography paragraph>
              ...
              <code>src\_app.js</code> to point to the new auth method. You need
