...
function MyCards() {
  ...
  const data = {
    logo1: '/assets/images/placeholders/logo/deutschebank_light.svg'
  };
      ...
      <List disablePadding>
        <ListItemWrapper>
          ...
          >
            <img
              alt="Spotify"
              src="/assets/images/placeholders/logo/spotify.svg"
            />
          </ListItemAvatar>
          <ListItemText
            primary="Spotify"
        ...
        <ListItemWrapper>
          ...
          >
            <img alt="Slack" src="/assets/images/placeholders/logo/slack.svg" />
          </ListItemAvatar>
          <ListItemText
            primary="Slack"
            primaryTypographyProps={{ variant: 'h5', noWrap: true }}
        ...
        <ListItemWrapper>
          ...
          >
            <img
              alt="AirBnB"
              src="/assets/images/placeholders/logo/airbnb.svg"
            />
          </ListItemAvatar>
          <ListItemText
            primary="AirBnB"
