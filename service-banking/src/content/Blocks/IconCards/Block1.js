      ...
      <Grid item xs={12} md={6}>
        <Card>
          <Box display="flex" alignItems="center" p={2}>
            <img
              style={{ height: 130 }}
              src="/assets/images/placeholders/illustrations/analysis.svg"
              alt="..."
            />
            <Box pl={1}>
              <Typography
      ...
      <Grid item xs={12} md={6}>
        <Card>
          <Box display="flex" alignItems="center" p={2}>
            <img
              style={{ height: 130 }}
              src="/assets/images/placeholders/illustrations/businessman.svg"
              alt="..."
            />
            <Box pl={1}>
              <Typography
      ...
      <Grid item xs={12} md={6}>
        <Card>
          <Box display="flex" alignItems="center" p={2}>
            <img
              style={{ height: 130 }}
              src="/assets/images/placeholders/illustrations/handshake.svg"
              alt="..."
            />
            <Box pl={1}>
              <Typography
      ...
      <Grid item xs={12} md={6}>
        <Card>
          <Box display="flex" alignItems="center" p={2}>
            <img
              style={{ height: 130 }}
              src="/assets/images/placeholders/illustrations/moving.svg"
              alt="..."
            />
            <Box pl={1}>
              <Typography
