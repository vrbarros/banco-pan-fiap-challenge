          ...
          >
            ...
            <BoxComposedImage
              sx={{
                opacity: 0.4,
                backgroundImage:
                  'url("/assets/images/placeholders/covers/1.jpg")'
              }}
            />
                  ...
                  <Tooltip arrow title={t('Sign in with Amplify')}>
                    ...
                    >
                      <img
                        style={{ height: 28 }}
                        alt="Amplify"
                        src="/assets/images/logo/amplify.svg"
                      />
                    </ButtonWrapper>
                  </Tooltip>
                  <Tooltip arrow title={t('Sign in with Auth0')}>
                    <ButtonWrapper size="large" variant="outlined">
                      <img
                        style={{ height: 28 }}
                        alt="Amplify"
                        src="/assets/images/logo/auth0.svg"
                      />
                    </ButtonWrapper>
                  </Tooltip>
                </CardWrapper>
                        ...
                        >
                          <CardActionArea>
                            <CardMedia
                              component="img"
                              height="64"
                              image="/assets/images/placeholders/fitness/1.jpg"
                              alt="..."
                            />
                          </CardActionArea>
                        </Card>
                        ...
                        >
                          <CardActionArea>
                            <CardMedia
                              component="img"
                              height="64"
                              image="/assets/images/placeholders/fitness/2.jpg"
                              alt="..."
                            />
                          </CardActionArea>
                        </Card>
                        ...
                        >
                          <CardActionArea>
                            <CardMedia
                              component="img"
                              height="64"
                              image="/assets/images/placeholders/fitness/3.jpg"
                              alt="..."
                            />
                          </CardActionArea>
                        </Card>
