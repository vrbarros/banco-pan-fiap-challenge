          ...
          <Container maxWidth="md">
            <Box textAlign="center">
              ...
              <Typography variant="h2" sx={{ my: 2 }}>
                {t('A página que está procurando não parece existir.')}
              </Typography>
              <Typography
                variant="h4"
              ...
              >
                {t(
                  'Talvez ajude tentar encontrar a página utilizando nossa busca abaixo.'
                )}
              </Typography>
            </Box>
              ...
              <Card sx={{ textAlign: 'center', mt: 3, p: 4 }}>
                <FormControl variant="outlined" fullWidth>
                  <OutlinedInputWrapper
                    type="text"
                    placeholder={t('O que está procurando?')}
                    endAdornment={
